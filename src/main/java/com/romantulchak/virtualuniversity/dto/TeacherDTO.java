...
public class TeacherDTO extends UserDTO{
    ...
    @JsonView({Views.SemesterView.class, Views.StudentGrades.class,Views.TeacherStudentGrades.class,Views.SubjectView.class, Views.StudentGroupView.class, Views.SubjectGrade.class})
    @Override
    public long getId() {
        return super.getId();
    }
